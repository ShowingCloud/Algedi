...
- **[AI Editor (Marakk)](https://github.com/ShowingCloud/Marakk/blob/master/README.md)** - Generative UI, Asset Management, and Prompt Engineering
- **[CMS (Yan)](https://github.com/ShowingCloud/Yan/blob/master/README.md)** - Page Hierarchy, Routing Logic, and Theme Management
- **[Commerce (Yen)](https://github.com/ShowingCloud/Yen/blob/master/README.md)** - Products, Orders, Customers, and Cart
